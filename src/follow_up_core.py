...
FOLLOW_UP_QUEUE_HEADERS = [
    "job_key", "company", "title", "outstanding_status", "last_status_update_date",
    "days_since_status_update", "follow_up_due", "follow_up_reason", "next_action",
    "next_action_date", "follow_up_date", "application_status", "review_status",
    "interview_stage", "review_notes", "canonical_url",
]

TERMINAL_APPLICATION_STATUSES = {"rejected", "closed", "withdrawn"}
TERMINAL_REVIEW_STATUSES = {"dismissed", "rejected", "closed", "withdrawn"}
INACTIVE_APPLICATION_STATUSES = {"", "not started", "not_started", "drafting"}
INACTIVE_REVIEW_STATUSES = {"", "not reviewed yet", "not reviewed", "not_reviewed"}
...
def infer_outstanding_status(job: JobPosting) -> str:
    ...
    if application_status in INACTIVE_APPLICATION_STATUSES and review_status in INACTIVE_REVIEW_STATUSES:
        return ""
    return ""
